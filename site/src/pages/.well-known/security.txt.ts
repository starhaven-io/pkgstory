...
const getSecurityTxt = (canonicalURL: URL) => {
  ...
  return `Contact: mailto:security@pkgstory.dev
Contact: https://github.com/starhaven-io/pkgstory/security/advisories/new
Expires: ${expires.toISOString()}
Preferred-Languages: en
Canonical: ${canonicalURL.href}
Policy: https://github.com/starhaven-io/pkgstory/security/policy
`;
};
